...
const TechnicalPDFCard = ({profile}) => {
    ...
    return (
        <Flex maxWidth="1000px" width="100%" flexDirection="column">
            ...
            <iframe src={"https://docs.google.com/viewer?url=" + "https:" + profile.fields.technicalProjects[index].fields.file.url + "&embedded=true"} style={{width: "100%", height: "70vh", marginBottom: 16}} frameBorder="0"></iframe>
